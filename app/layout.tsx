...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: "Of Blood - Blackened Death Metal",
    title: "Of Blood | Blackened Death Metal Band - Official Website",
    description: "Official website of Of Blood, a blackened death metal band exploring cosmic horror, existential dread, and apocalyptic themes. Listen to music, view tour dates, shop merch.",
    images: [
      {
        url: "/api/og",
        width: 1200,
        height: 630,
        alt: "Of Blood - Blackened Death Metal Band Logo",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Of Blood | Blackened Death Metal Band",
    description: "Official website of Of Blood - Blackened death metal exploring cosmic horror and existential dread. Listen to music, tour dates, and merch.",
